...
pub struct JSCClassVTable {
	...
	pub _jsc_reserved0: Option<unsafe extern fn()>,
	pub _jsc_reserved1: Option<unsafe extern fn()>,
	pub _jsc_reserved2: Option<unsafe extern fn()>,
	pub _jsc_reserved3: Option<unsafe extern fn()>,
}
...
impl ::std::fmt::Debug for JSCContext {
	fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
		f.debug_struct(&format!("JSCContext @ {self:p}")).field("parent", &self.parent).finish()
	}
}
...
impl ::std::fmt::Debug for JSCException {
	fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
		f.debug_struct(&format!("JSCException @ {self:p}")).field("parent", &self.parent).finish()
	}
}
...
impl ::std::fmt::Debug for JSCValue {
	fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
		f.debug_struct(&format!("JSCValue @ {self:p}")).field("parent", &self.parent).finish()
	}
}
...
impl ::std::fmt::Debug for JSCWeakValue {
	fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
		f.debug_struct(&format!("JSCWeakValue @ {self:p}")).field("parent", &self.parent).finish()
	}
}
